...
public class TestRental {
    ...
    public TestRental(){
        ...
        allTrips[1] = new HolidayTrip("Debby Wu", 4, 200, true);
        allTrips[2] = new HolidayTrip("Steven Lin", 1, 100, true);
        allTrips[3] = new HolidayTrip("George Hsu", 1, 300, false);
        allTrips[4] = new RegularTrip("David Hsu", 3, 300, false);
        numOfTrips = 5;
    }
