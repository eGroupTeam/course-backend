...
public class OrganizationController {
  ...
  public Organization retrieveOneOrganization(@PathVariable("organizationId") int organizationId) throws SQLException, Exception {
  ...
  public void processFormUpdate(@RequestBody Organization organization, @PathVariable("organizationId") int organizationId) throws Exception {
  ...
  public void delete(@PathVariable("organizationId") int organizationId) throws Exception {
