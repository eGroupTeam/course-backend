...
public class CustomerDAOImpl implements CustomerDAO {
  ...
  private Customer getCustomer(ResultSet rs) throws SQLException, Exception {
    return new Customer(rs.getLong("id"),rs.getString("name"),rs.getString("address"),rs.getInt("weight"));
  }
  ...
  public List<AddressCount> getGroupByAddressList() throws Exception {
    ...
    try (
      ...
      while (rs.next()) {
        ...
        // customers.add(new AddressCount(rs.getString("address"),
        // rs.getInt("COUNT(address)")));
